 ...
 * 
 */
@SuppressLint("NewApi") public class GiaDinhFragment extends Fragment {
	ListView lvData;
	WordAdapter adapter;
	public static GiaDinhFragment newInstance(String param1, String param2) {
		GiaDinhFragment fragment = new GiaDinhFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_gia_dinh, container, false);
		return view;
	}
	@Override
