 ...
 * 
 */
@SuppressLint("NewApi") public class DatNuocFragment extends Fragment {
	ListView lvData;
	WordAdapter adapter;
	public static DatNuocFragment newInstance(String param1, String param2) {
		DatNuocFragment fragment = new DatNuocFragment();
		Bundle args = new Bundle();
		fragment.setArguments(args);
		return fragment;
	}

	public DatNuocFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_dat_nuoc, container, false);
		return view;
	}
	@Override
