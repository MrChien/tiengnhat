 ...
 * 
 */
@SuppressLint("NewApi") public class NgayGioFragment extends Fragment {
	ListView lvData;
	WordAdapter adapter;
	public static NgayGioFragment newInstance(String param1, String param2) {
		NgayGioFragment fragment = new NgayGioFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view  =inflater.inflate(R.layout.fragment_ngay_gio, container, false);
		return view;
	}
	@Override
