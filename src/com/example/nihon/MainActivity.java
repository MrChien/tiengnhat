...
import Adapter.DrawerListItemAdapter;
...
public class MainActivity extends Activity {
	...
	private void selectItem(int position) {
		...
		case 3:
			...
			return;
		case 4:
			fragment = new GiaDinhFragment();
			break;
		case 5:
			fragment = new AnUongFragment();
		case 6:
			fragment = new NgayGioFragment();
		case 7:
			fragment = new MauSacFragment();
		case 8:
			fragment = new DatNuocFragment();
