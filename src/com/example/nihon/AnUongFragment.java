...
public class AnUongFragment extends Fragment {
	ListView lvData;
	WordAdapter adapter;
	public static AnUongFragment newInstance(String param1, String param2) {
		AnUongFragment fragment = new AnUongFragment();
		Bundle args = new Bundle();
		fragment.setArguments(args);
		return fragment;
	}
	public AnUongFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_an_uong, container,
				false);
		return view;
	}
